...
const Data: CVData = {
  ...
  skills: [
    ...
    },
    {
      ...
      skills: ["Unity", "3D Game Physics", "Multiplayer Networking", "Custom Engine Development"]
    }
  ],
  ...
  projects: [
    ...
    // Full-stack Web Dev
    {
      ...
      technologies: ["Next.js", "Python", "FastAPI", "VectorDB", "LangGraph", "TypeScript", "Supabase", "Redis"]
    },
    {
      id: "web2",
      name: "EchoReview",
      ...
      technologies: ["Next.js", "TypeScript", "PostgreSQL", "PrismaORM", "TogetherAPI"]
    },
    {
      id: "web3",
      name: "Multicoder",
    ...
    {
      id: "sys3",
      name: "Arena Garbage Collector",
      description:
        "Arena-based memory allocator and garbage collection strategy for deterministic, fast allocation and bulk deallocation. Designed to serve language runtimes and short-lived object lifecycles where linear allocation and reset semantics are beneficial.",
    ...
    // Machine Learning
    {
      ...
      description: "A fully custom neural network implementation written from scratch in C. Designed as a general-purpose function approximator capable of learning mappings from point sets, with future extensions planned for image recognition tasks.",
      technologies: ["C", "mathematics", "backpropagation", "custom data structures"]
    },
